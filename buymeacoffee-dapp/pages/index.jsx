    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.front}>
            <div className={styles.fronttitle}>
                <Image src="/backimg1.jpg" width={100} height={100} className={styles.images}></Image>
            </div>
            <div className={styles.frontcontent}>
                {currentAccount ? (
                    <form className={styles.form}>
                        <div className={styles.formusername}>
                            <input id="name" type="text" placeholder="name" onChange={onNameChange} />
                        </div>

                        <div>
                            <textarea rows={3} placeholder="message" id="message" onChange={onMessageChange} required>
                            </textarea>
                        </div>
      ...
      <footer className={styles.footer}>
        <a href="https://alchemy.com/?a=roadtoweb3weektwo" target="_blank" rel="noopener noreferrer">
          Created by @Whyat9 for Alchemy's Road to Web3 lesson two!
        </a>
      </footer>
    </div>
  )
